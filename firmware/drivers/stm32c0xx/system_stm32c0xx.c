 ...
 * LSE_VALUE
 *
 *         (**) HSI_VALUE is a constant defined in stm32c0xx_hal_conf.h file
 * (default value 48 MHz) but the real value may vary depending on the
 * variations in voltage and temperature.
 *
 *         (***) HSE_VALUE is a constant defined in stm32c0xx_hal_conf.h file
 * (default value 48 MHz), user has to ensure that HSE_VALUE is same as the real
